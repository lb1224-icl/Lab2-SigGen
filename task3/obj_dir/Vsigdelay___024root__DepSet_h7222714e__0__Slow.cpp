...
VL_ATTR_COLD void Vsigdelay___024root___ctor_var_reset(Vsigdelay___024root* vlSelf) {
    ...
    vlSelf->sigdelay__DOT__ram_out = VL_RAND_RESET_I(8);
    vlSelf->sigdelay__DOT__addrCounter__DOT__step = VL_RAND_RESET_I(9);
    for (int __Vi0=0; __Vi0<512; ++__Vi0) {
        vlSelf->sigdelay__DOT__delayRAM__DOT__ram_array[__Vi0] = VL_RAND_RESET_I(8);
    }
