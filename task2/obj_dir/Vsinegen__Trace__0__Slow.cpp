...
VL_ATTR_COLD void Vsinegen___024root__trace_init_sub__TOP__0(Vsinegen___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+4,"step", false,-1, 7,0);
    tracep->declBus(c+5,"doutA", false,-1, 7,0);
    tracep->declBus(c+6,"doutB", false,-1, 7,0);
    ...
    tracep->declBit(c+2,"rst", false,-1);
    tracep->declBit(c+3,"en", false,-1);
    tracep->declBus(c+10,"step", false,-1, 7,0);
    ...
    tracep->declBit(c+1,"clk", false,-1);
    tracep->declBus(c+7,"addrA", false,-1, 7,0);
    tracep->declBus(c+8,"addrB", false,-1, 7,0);
    tracep->declBus(c+5,"doutA", false,-1, 7,0);
    tracep->declBus(c+6,"doutB", false,-1, 7,0);
...
VL_ATTR_COLD void Vsinegen___024root__trace_full_sub_0(Vsinegen___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+4,(vlSelf->step),8);
    bufp->fullCData(oldp+5,(vlSelf->doutA),8);
    bufp->fullCData(oldp+6,(vlSelf->doutB),8);
    ...
    bufp->fullCData(oldp+10,(vlSelf->sinegen__DOT__addrCounter__DOT__step),8);
}
