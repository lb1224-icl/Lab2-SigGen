...
void Vsinegen___024root__trace_chg_sub_0(Vsinegen___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+3,(vlSelf->step),8);
    bufp->chgCData(oldp+4,(vlSelf->doutA),8);
    bufp->chgCData(oldp+5,(vlSelf->doutB),8);
    bufp->chgCData(oldp+6,(vlSelf->sinegen__DOT__address),8);
    bufp->chgCData(oldp+7,((0xffU & ((IData)(vlSelf->sinegen__DOT__address) 
                                     + (IData)(vlSelf->step)))),8);
}
