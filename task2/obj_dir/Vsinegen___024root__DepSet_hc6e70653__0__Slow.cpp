...
VL_ATTR_COLD void Vsinegen___024root___ctor_var_reset(Vsinegen___024root* vlSelf) {
    ...
    vlSelf->step = VL_RAND_RESET_I(8);
    vlSelf->doutA = VL_RAND_RESET_I(8);
    vlSelf->doutB = VL_RAND_RESET_I(8);
    vlSelf->sinegen__DOT__address = VL_RAND_RESET_I(8);
    vlSelf->sinegen__DOT__addrCounter__DOT__step = VL_RAND_RESET_I(8);
